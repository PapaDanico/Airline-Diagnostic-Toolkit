...
const JK = {
  ...
  domains: [
    ...
    },
    {
      ...
      benchmark: "Cirium ranks airlines on ARRIVALS at the gate within 15 minutes of schedule — not departures, which is what the question below asks and what most carriers quote internally. On that arrivals measure the 2025 leaders were Aeromexico at 90.02%, Saudia at 86.53% and SAS at 86.09%, with Qatar Airways at 84.42% across 198,303 flights. Read your departure figure as the more flattering of the two: it does not carry the delay an aircraft accumulates en route. Cirium ranks only carriers it holds data on for 80% or more of flights, which is itself a test of whether an operation is measured at all.",
      benchmarkSrc: "Cirium On-Time Performance Review 2025", benchmarkAsOf: "2026-01-05", benchmarkCadence: "annual",
    ...
    },
    {
      ...
      benchmarkSrc: "IATA / AFRAA, 2025", benchmarkAsOf: "2025-12-31", benchmarkCadence: "annual",
    ...
    },
    {
      ...
      benchmarkSrc: "IATA, Cost Disadvantage of African Airlines, 2025", benchmarkAsOf: "2025-06-30", benchmarkCadence: "annual",
    ...
    },
    {
      ...
      benchmark: "Across the 61 airlines IdeaWorksCompany surveyed for 2024, the leaders on ancillary revenue per passenger were Norse Atlantic at $100.40, Jet2.com at $89.99 and Breeze at $89.82. Worldwide ancillary revenue passed $148 billion, and the 58 carriers comparable year-on-year grew it 2.5% per passenger while fares fell — which is the whole argument for the line. The survey is of carriers that report ancillary separately; a carrier that cannot say what its own figure is has already answered this domain.",
      benchmarkSrc: "IdeaWorksCompany / CarTrawler Yearbook of Ancillary Revenue 2025 (2024 financial year)", benchmarkAsOf: "2025-08-31", benchmarkCadence: "annual",
    ...
    },
    {
      ...
      canvasLink: true,
      benchmark: "African carriers turned $300 million in 2025 on a 1.6% net margin — $2.10 per passenger. IATA's June 2026 revision cuts 2026 to $100 million, a 0.2% margin and $0.40 per passenger: half the $200 million it forecast in December, and a third of what the region actually earned. Jet fuel went from 25.4% of industry operating costs to 31.4% in a single revision. A margin of 0.2% does not absorb a bad quarter; it does not absorb a bad week.",
      benchmarkSrc: "IATA Global Outlook for Air Transport, June 2026", benchmarkAsOf: "2026-06-07", benchmarkCadence: "semiannual",
